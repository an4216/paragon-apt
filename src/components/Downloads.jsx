...
function Downloads() {
  const files = [
    ...
    { cat: '평면도', name: '62B 타입 평면도 (전용 62.9977㎡)', size: '226 KB', ext: 'JPG', date: '2022.05.23', href: 'floor-plan-docs/62B.jpg' },
    { cat: '평면도', name: '76 타입 평면도 (전용 76.6893㎡)',   size: '171 KB', ext: 'JPG', date: '2022.05.23', href: 'floor-plan-docs/76.jpg'  },
